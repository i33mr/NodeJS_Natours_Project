...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1IjoiaTMzbXIiLCJhIjoiY2t4eXZiOGFwNDBuczJva282Z3dwbDFxbCJ9.rTgvmfNAe8Rtbhqsmtv3cw";
  var map = new mapboxgl.Map({
    container: "map",
    style: "mapbox://styles/i33mr/ckxyvlhnl3hhy14l57dykigh2",
    scrollZoom: false // center: [-118, 34.111],
    // zoom: 10,
    // interactive: false,
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // Extend map bounds to include current location, specify paddings for the map
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe("pk_test_51KEtyOD9mT7tMDmDo9EKinvN6KD7jjxWKMrBgmTIAfyGTrRRPjTrCyBrHH3Kwp8bmEtkExb8TeSoNBbuimgh5GIa00F4HT6BWH"); // 1) Get checkout session from API
          ...
          case 9:
            _context.prev = 9;
            _context.t0 = _context["catch"](0);
            (0, _alerts.showAlert)("error", _context.t0); // console.log(erro)
...
var logoutBottom = document.querySelector(".nav__el--logout");
...
if (logoutBottom) {
  logoutBottom.addEventListener("click", _login.logout);
}
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              e.preventDefault();
              document.querySelector(".btn--save-settings").textContent = "Updating..."; // the form is needed to send the photo (multi-part)
            ...
            case 8:
              document.querySelector(".btn--save-settings").textContent = "Save settings"; // to automatically show the new img
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              passwordConfirm = document.getElementById("password-confirm").value; // Since updateSettings is async function, we can use await to wait for it to return, and after that clear the form fields
...
},{"regenerator-runtime/runtime":"../../node_modules/regenerator-runtime/runtime.js","./login":"login.js","./updateSettings":"updateSettings.js","./mapbox":"mapbox.js","./stripe":"stripe.js"}]},{},["index.js"], null)
