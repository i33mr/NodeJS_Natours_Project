...
exports.alerts = (req, res, next) => {
  ...
  if (alert === "booking") {
    res.locals.alert =
      "Your booking was successful! Please check your email for a confirmation. If your booking doesn't show up here immediately, please check again later";
  }
  next();
};
...
exports.getTour = catchAsync(async (req, res, next) => {
  ...
  res
    .status(200)
    // .set is to fix the mapbox error, comment it for more info
    .set(
